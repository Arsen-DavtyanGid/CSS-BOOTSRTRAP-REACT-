      ...
      <div className="container">
        <div className="row">
          <div className="col-lg-12">
            <div className="section5-text">Testimonials</div>
          </div>
        </div>
        <div className="row">
          <div className="col-lg-6">
            <div className="section5-content">
              <div className="section5-stars">
                <div className="section5-s">
                  <svg
                    width="26"
                    height="24"
                    viewBox="0 0 26 24"
              ...
              <div className="section5-text1">
                “Quisque in lacus a urna fermentum euismod. Integer mi nibh,
                dapibus ac scelerisque eu, facilisis quis purus. Morbi blandit
                sit amet turpis nec”
              </div>
              <div className="section5-text2">Edward Newgate</div>
              <div className="section5-text3">Founder Circle</div>
            </div>
          </div>
          <div className="col-lg-6">
            <div className="section5-img">
              <img src={props.s5img} alt="img" />
            </div>
          </div>
        </div>
      </div>
